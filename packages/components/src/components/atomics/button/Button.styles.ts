...
export type SolidButtonVariants = VariantProps<typeof solidButton>;
export type OutlinedButtonVariants = VariantProps<typeof outlinedButton>;
export type ButtonVariants = SolidButtonVariants | OutlinedButtonVariants;
