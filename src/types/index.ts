...
type CleanProps<TTag extends ReactTag, TOmitableProps extends PropertyKey = __> = TOmitableProps extends __
...
type ClassNameOverride<TTag extends ReactTag, TSlot = UnknownObject> =
...
export type Props<TTag extends ReactTag, TSlot = UnknownObject, TOmitableProps extends PropertyKey = __> = CleanProps<
  TTag,
  TOmitableProps
> &
  OurProps<TTag, TSlot> &
