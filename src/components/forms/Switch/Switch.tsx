        ...
        >
          <span
            className={clsx(
              ...
              toIntentMatch({
                default: () => clsx('bg-default border-default-6'),
                neutral: () => clsx('bg-neutral border-neutral-6'),
                light: () => clsx('bg-light border-light-6'),
                dark: () => clsx('bg-dark border-dark-6'),
                primary: () => clsx('bg-primary border-primary-6'),
                info: () => clsx('bg-info border-info-6'),
                success: () => clsx('bg-success border-success-6'),
                warning: () => clsx('bg-warning border-warning-6'),
                danger: () => clsx('bg-danger border-danger-6'),
              })(intent),
            )}
          >
            {children}
