      ...
      <BaseSwitch.Group>
        <BaseSwitch
          ...
          className={clsx(
            ...
            toIntentMatch({
              neutral: () => clsx('outlined-neutral'),
              light: () => clsx('outlined-light'),
              dark: () => clsx('outlined-dark'),
              primary: () => clsx('outlined-primary'),
              info: () => clsx('outlined-info'),
              success: () => clsx('outlined-success'),
              accent: () => clsx('outlined-accent'),
              warning: () => clsx('outlined-warning'),
              danger: () => clsx('outlined-danger'),
            })(intent),
          )}
        >
          <span
