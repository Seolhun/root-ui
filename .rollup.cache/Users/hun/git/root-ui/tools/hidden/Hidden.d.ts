...
export declare const Hidden: (<Tag extends ElementType<any> = "div">(props: Omit<import("~/types").PropsOf<Tag>, "children" | "className" | "as" | "refName"> & import("~/types").RootUIOurProps<Tag, import("~/types").UnknownObject> & (true extends (import("~/types").PropsOf<Tag> extends infer T ? T extends import("~/types").PropsOf<Tag> ? T extends never ? never : "className" extends infer T_1 ? T_1 extends "className" ? T_1 extends keyof T ? true : never : never : never : never : never) ? {
